package com.amarsoft.dev.modular.file.service.impl;
...
import com.amarsoft.dev.modular.file.service.DevFileService;
...
import com.amarsoft.common.prop.CommonProperties;
import com.amarsoft.common.util.CommonDownloadUtil;
import com.amarsoft.common.util.CommonResponseUtil;
import com.amarsoft.dev.modular.file.entity.DevFile;
import com.amarsoft.dev.modular.file.enums.DevFileEngineTypeEnum;
import com.amarsoft.dev.modular.file.mapper.DevFileMapper;
import com.amarsoft.dev.modular.file.param.DevFileIdParam;
import com.amarsoft.dev.modular.file.param.DevFileListParam;
import com.amarsoft.dev.modular.file.param.DevFilePageParam;
import com.amarsoft.dev.modular.file.util.DevFileAliyunUtil;
import com.amarsoft.dev.modular.file.util.DevFileLocalUtil;
import com.amarsoft.dev.modular.file.util.DevFileMinIoUtil;
import com.amarsoft.dev.modular.file.util.DevFileTencentUtil;
    ...
    private String storageFile(String engine, MultipartFile file, boolean returnFileId) {
        ...
        if(engine.equals(DevFileEngineTypeEnum.LOCAL.getValue())) {
            ...
            if(ObjectUtil.isEmpty(apiUrl)) {
                throw new CommonException("后端域名地址未正确配置：support.config.common.backend-url为空");
            }
