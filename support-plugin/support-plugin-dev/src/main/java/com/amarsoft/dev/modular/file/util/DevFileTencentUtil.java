...
public class DevFileTencentUtil {
    ...
    private static final String SUPPORT_FILE_TENCENT_SECRET_ID_KEY = "SUPPORT_FILE_TENCENT_SECRET_ID";
    private static final String SUPPORT_FILE_TENCENT_SECRET_KEY_KEY = "SUPPORT_FILE_TENCENT_SECRET_KEY";
    private static final String SUPPORT_FILE_TENCENT_REGION_ID_KEY = "SUPPORT_FILE_TENCENT_REGION_ID";
    private static final String SUPPORT_FILE_TENCENT_DEFAULT_BUCKET_NAME = "SUPPORT_FILE_TENCENT_DEFAULT_BUCKET_NAME";
    ...
    private static void initClient() {
        ...
        /* secretId */
        String secretId = devConfigApi.getValueByKey(SUPPORT_FILE_TENCENT_SECRET_ID_KEY);
        ...
        /* secretKey */
        String secretKey = devConfigApi.getValueByKey(SUPPORT_FILE_TENCENT_SECRET_KEY_KEY);
        ...
        /* regionId */
        String regionId = devConfigApi.getValueByKey(SUPPORT_FILE_TENCENT_REGION_ID_KEY);
        ...
        /* 默认BucketName */
        defaultBucketName = devConfigApi.getValueByKey(SUPPORT_FILE_TENCENT_DEFAULT_BUCKET_NAME);
