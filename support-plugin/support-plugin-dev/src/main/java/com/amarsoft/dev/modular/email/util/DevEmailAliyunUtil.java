package com.amarsoft.dev.modular.email.util;
...
public class DevEmailAliyunUtil {
    ...
    private static final String SUPPORT_EMAIL_ALIYUN_ACCESS_KEY_ID_KEY = "SUPPORT_EMAIL_ALIYUN_ACCESS_KEY_ID";
    private static final String SUPPORT_EMAIL_ALIYUN_ACCESS_KEY_SECRET_KEY = "SUPPORT_EMAIL_ALIYUN_ACCESS_KEY_SECRET";
    private static final String SUPPORT_EMAIL_ALIYUN_REGION_ID_KEY = "SUPPORT_EMAIL_ALIYUN_REGION_ID";
    ...
    private static void initClient() {
        ...
        /* accessKeyId */
        String accessKeyId = devConfigApi.getValueByKey(SUPPORT_EMAIL_ALIYUN_ACCESS_KEY_ID_KEY);
        ...
        /* accessKeySecret */
        String accessKeySecret = devConfigApi.getValueByKey(SUPPORT_EMAIL_ALIYUN_ACCESS_KEY_SECRET_KEY);
        ...
        /* regionId */
        String regionId = devConfigApi.getValueByKey(SUPPORT_EMAIL_ALIYUN_REGION_ID_KEY);
