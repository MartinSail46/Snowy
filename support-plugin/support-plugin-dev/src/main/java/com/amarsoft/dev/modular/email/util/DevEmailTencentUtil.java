...
public class DevEmailTencentUtil {
    ...
    private static final String SUPPORT_EMAIL_TENCENT_SECRET_ID_KEY = "SUPPORT_EMAIL_TENCENT_SECRET_ID";
    private static final String SUPPORT_EMAIL_TENCENT_SECRET_KEY_KEY = "SUPPORT_EMAIL_TENCENT_SECRET_KEY";
    private static final String SUPPORT_EMAIL_TENCENT_REGION_ID_KEY = "SUPPORT_EMAIL_TENCENT_REGION_ID";
    ...
    private static void initClient() {
        ...
        /* secretId */
        String secretId = devConfigApi.getValueByKey(SUPPORT_EMAIL_TENCENT_SECRET_ID_KEY);
        ...
        /* secretKey */
        String secretKey = devConfigApi.getValueByKey(SUPPORT_EMAIL_TENCENT_SECRET_KEY_KEY);
        ...
        /* regionId */
        String regionId = devConfigApi.getValueByKey(SUPPORT_EMAIL_TENCENT_REGION_ID_KEY);
