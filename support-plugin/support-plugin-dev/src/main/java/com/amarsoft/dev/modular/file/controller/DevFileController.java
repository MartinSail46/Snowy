package com.amarsoft.dev.modular.file.controller;
 ...
 **/
@Api(tags = "文件控制器")
@ApiSupport(author = "SUPPORT_TEAM", order = 4)
@RestController
@Validated
public class DevFileController {

    /** 默认文件引擎 */
    private static final String SUPPORT_SYS_DEFAULT_FILE_ENGINE_KEY = "SUPPORT_SYS_DEFAULT_FILE_ENGINE";
    ...
    public CommonResult<String> uploadDynamicReturnId(@RequestPart("file") MultipartFile file) {
        return CommonResult.data(devFileService.uploadReturnId(devConfigApi.getValueByKey(SUPPORT_SYS_DEFAULT_FILE_ENGINE_KEY), file));
    }
    ...
    public CommonResult<String> uploadDynamicReturnUrl(@RequestPart("file") MultipartFile file) {
        return CommonResult.data(devFileService.uploadReturnUrl(devConfigApi.getValueByKey(SUPPORT_SYS_DEFAULT_FILE_ENGINE_KEY), file));
    }
