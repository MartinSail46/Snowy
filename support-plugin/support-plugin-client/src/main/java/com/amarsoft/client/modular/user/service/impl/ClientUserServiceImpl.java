package com.amarsoft.client.modular.user.service.impl;
...
import com.amarsoft.client.modular.user.mapper.ClientUserMapper;
import com.amarsoft.client.modular.user.result.ClientLoginUser;
import com.amarsoft.client.modular.user.service.ClientUserService;
import com.amarsoft.common.util.*;
...
import com.amarsoft.client.modular.relation.service.ClientRelationService;
import com.amarsoft.client.modular.user.entity.ClientUser;
import com.amarsoft.client.modular.user.enums.ClientUserStatusEnum;
import com.amarsoft.client.modular.user.param.ClientUserAddParam;
import com.amarsoft.client.modular.user.param.ClientUserEditParam;
import com.amarsoft.client.modular.user.param.ClientUserIdParam;
import com.amarsoft.client.modular.user.param.ClientUserPageParam;
...
public class ClientUserServiceImpl extends ServiceImpl<ClientUserMapper, ClientUser> implements ClientUserService {
    ...
    public void add(ClientUserAddParam clientUserAddParam) {
        ...
        // 设置默认密码
        clientUser.setPassword(CommonCryptogramUtil.doHashValue(devConfigApi.getValueByKey(SUPPORT_SYS_DEFAULT_PASSWORD_KEY)));
        // 设置状态
